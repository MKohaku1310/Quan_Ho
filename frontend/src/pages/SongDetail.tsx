    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-20 text-center">
          <p className="text-muted-foreground">Không tìm thấy bài hát.</p>
          <Link to="/bai-hat" className="mt-4 inline-block text-primary hover:underline">← Quay lại</Link>
        </div>
        <Footer />
      </div>
    );
          ...
          >
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mt-3 flex flex-wrap gap-4 text-sm text-muted-foreground">
                ...
                <span className="flex items-center gap-1"><MapPin className="h-4 w-4" /> Làng {song.village}</span>
              ...
              {/* Lyrics */}
              <div className="mt-8">
                <h2 className="font-display text-xl font-semibold text-card-foreground">Lời bài hát</h2>
